...
function check_if_device_valid_after(){
  ...
  user_code = document.getElementById("code").value;
    ...
    if (check){
     ...
     check_validity_after('/check_if_valid_after', data_to_send)
}
...
function check_validity_after(url, data) {
    ...
    .then(data => {
        ...
        alert ('You entered a wrong code OR you are not using the required device')
        }
