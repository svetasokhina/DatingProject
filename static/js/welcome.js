...
function check_validity(url, data) {
    ...
    .then(data => {
        ...
        if(data.device=='PC'){
         window.location.href='/random_Mob?param=' + data_to_instructions;
        }
         else{
             window.location.href='/random_PC?param=' + data_to_instructions;
         }
        }
